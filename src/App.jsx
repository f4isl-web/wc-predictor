      ...
      fbListen("matches_v2", v=>{
        if(v){
          ...
          const merged = arr.map(m => {
            ...
            if(!def) return m;
            // Teams ALWAYS come from the code (DEFAULT_MATCHES), for every round.
            // This guarantees any fixture edit you make in code shows up on deploy.
            // Only the entered result (scores/scorers) is preserved from Firebase.
