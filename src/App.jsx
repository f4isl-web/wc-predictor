...
function calcPoints(pred, result) {
  ...
  // Knockout penalties: if the real match was a draw decided on penalties, award +1
  // for correctly predicting the penalty winner.
  if(rh===ra && result.penWinner && pred?.penWinner && result.penWinner===pred.penWinner){
    pts += 1;
  }
  return pts;
}
...
const DEFAULT_MATCHES = [
  ...
  {id:59,phase:"Group J",home:"Algeria 🇩🇿",away:"Austria 🇦🇹",date:"Jun 28",kickoffTime:"2026-06-28T05:00+03:00"},
  {id:60,phase:"Group J",home:"Jordan 🇯🇴",away:"Argentina 🇦🇷",date:"Jun 28",kickoffTime:"2026-06-28T05:00+03:00"},
  ...
  {id:73,phase:"Round of 32",home:"South Africa 🇿🇦",away:"Canada 🇨🇦",date:"Jun 28",kickoffTime:"2026-06-28T22:00+03:00"},
  {id:74,phase:"Round of 32",home:"Germany 🇩🇪",away:"Paraguay 🇵🇾",date:"Jun 29",kickoffTime:"2026-06-29T23:30+03:00"},
  {id:75,phase:"Round of 32",home:"Brazil 🇧🇷",away:"Japan 🇯🇵",date:"Jun 29",kickoffTime:"2026-06-29T20:00+03:00"},
  {id:76,phase:"Round of 32",home:"Netherlands 🇳🇱",away:"Morocco 🇲🇦",date:"Jun 30",kickoffTime:"2026-06-30T04:00+03:00"},
  {id:77,phase:"Round of 32",home:"France 🇫🇷",away:"Sweden 🇸🇪",date:"Jul 1",kickoffTime:"2026-07-01T00:00+03:00"},
  {id:78,phase:"Round of 32",home:"Ivory Coast 🇨🇮",away:"Norway 🇳🇴",date:"Jun 30",kickoffTime:"2026-06-30T20:00+03:00"},
  {id:79,phase:"Round of 32",home:"Mexico 🇲🇽",away:"Ecuador 🇪🇨",date:"Jul 1",kickoffTime:"2026-07-01T04:00+03:00"},
  {id:80,phase:"Round of 32",home:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",away:"DR Congo 🇨🇩",date:"Jul 1",kickoffTime:"2026-07-01T19:00+03:00"},
  {id:81,phase:"Round of 32",home:"USA 🇺🇸",away:"Bosnia & Herz. 🇧🇦",date:"Jul 2",kickoffTime:"2026-07-02T03:00+03:00"},
  {id:82,phase:"Round of 32",home:"Belgium 🇧🇪",away:"Senegal 🇸🇳",date:"Jul 1",kickoffTime:"2026-07-01T23:00+03:00"},
  {id:83,phase:"Round of 32",home:"Portugal 🇵🇹",away:"Croatia 🇭🇷",date:"Jul 3",kickoffTime:"2026-07-03T02:00+03:00"},
  {id:84,phase:"Round of 32",home:"Spain 🇪🇸",away:"Austria 🇦🇹",date:"Jul 2",kickoffTime:"2026-07-02T22:00+03:00"},
  {id:85,phase:"Round of 32",home:"Switzerland 🇨🇭",away:"Algeria 🇩🇿",date:"Jul 3",kickoffTime:"2026-07-03T06:00+03:00"},
  {id:86,phase:"Round of 32",home:"Argentina 🇦🇷",away:"Cape Verde 🇨🇻",date:"Jul 4",kickoffTime:"2026-07-04T01:00+03:00"},
  {id:87,phase:"Round of 32",home:"Colombia 🇨🇴",away:"Ghana 🇬🇭",date:"Jul 4",kickoffTime:"2026-07-04T04:30+03:00"},
  {id:88,phase:"Round of 32",home:"Australia 🇦🇺",away:"Egypt 🇪🇬",date:"Jul 3",kickoffTime:"2026-07-03T21:00+03:00"},
  {id:89,phase:"Round of 16",home:"Australia/Egypt",away:"Argentina/Cape Verde",date:"Jul 4",kickoffTime:"2026-07-04T19:00+03:00"},
  {id:90,phase:"Round of 16",home:"Canada 🇨🇦",away:"Morocco 🇲🇦",date:"Jul 4",kickoffTime:"2026-07-04T20:00+03:00"},
  {id:91,phase:"Round of 16",home:"Switzerland/Algeria",away:"Colombia/Ghana",date:"Jul 4",kickoffTime:"2026-07-04T23:00+03:00"},
  {id:92,phase:"Round of 16",home:"Spain/Austria",away:"Portugal/Croatia",date:"Jul 5",kickoffTime:"2026-07-05T22:00+03:00"},
  {id:93,phase:"Round of 16",home:"Brazil 🇧🇷",away:"Norway 🇳🇴",date:"Jul 5",kickoffTime:"2026-07-05T23:00+03:00"},
  {id:94,phase:"Round of 16",home:"Paraguay 🇵🇾",away:"France 🇫🇷",date:"Jul 6",kickoffTime:"2026-07-06T00:00+03:00"},
  {id:95,phase:"Round of 16",home:"Mexico 🇲🇽",away:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",date:"Jul 6",kickoffTime:"2026-07-06T03:00+03:00"},
  {id:96,phase:"Round of 16",home:"Belgium 🇧🇪",away:"USA 🇺🇸",date:"Jul 7",kickoffTime:"2026-07-07T03:00+03:00"},
...
export default function App() {
      ...
      fbListen("matches_v2", v=>{
        if(v){
          ...
          const merged = arr.map(m => {
            ...
            if(!def) return m;
            // R16+ (id >= 89) preserve teams (set manually as bracket progresses).
            // Group + R32 (id <= 88) sync teams from code so confirmed fixtures show.
            const preserveTeams = m.id >= 89;
            const fixed = preserveTeams
              ? { ...m, date:def.date, phase:def.phase, kickoffTime:def.kickoffTime }
              : { ...m, home:def.home, away:def.away, date:def.date, phase:def.phase, kickoffTime:def.kickoffTime };
            if((!preserveTeams && (m.home!==def.home || m.away!==def.away)) || m.date!==def.date || m.phase!==def.phase || m.kickoffTime!==def.kickoffTime){
              needsUpdate = true;
            }
            return fixed;
          });
  ...
  // Admin: manually set a knockout match's team name (home/away)
  const setMatchTeam=(id,side,val)=>{
    fbSet(`matches_v2/${id}/${side}`,val);
    setMatches(prev=>prev.map(m=>m.id===id?{...m,[side]:val}:m));
  };
  ...
  // One-time: force the knockout matches (id >= 73) to update from code into Firebase,
  // overwriting cached placeholders. Preserves any entered results.
  const refreshKnockout=async()=>{
    showToast("Refreshing knockout…");
    const fresh = (await fbGet("matches_v2")) || {};
    let n=0;
    for(const def of DEFAULT_MATCHES){
      if(def.id < 73) continue;
      const existing = fresh[def.id] || {};
      // Delete the node first to clear any stale fields, then write the full correct match
      await fbSet(`matches_v2/${def.id}`, null);
      const fullMatch = {
        id: def.id,
        phase: def.phase,
        home: def.home,
      ...
      await fbSet(`matches_v2/${def.id}`, fullMatch);
      // Update local state immediately too
      setMatches(prev=>prev.map(m=>m.id===def.id?fullMatch:m));
      n++;
    }
    showToast(`Knockout fully refreshed (${n} matches)`);
  };
          ...
          {!activeLeague ? <NoLeague/> : <>
            ...
            {[...visibleMatches].sort((a,b)=>{
              ...
              return <div key={m.id} style={{background:T.card,border:`1px solid ${locked&&!hasRes?"rgba(255,100,0,.2)":T.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                ...
                {m.id>=73 && pred.homeScore!=null && pred.homeScore!=="" && pred.awayScore!=null && pred.awayScore!=="" && parseInt(pred.homeScore)===parseInt(pred.awayScore) && <div style={{marginTop:10,paddingTop:10,borderTop:"1px solid rgba(255,170,0,.15)"}}>
                  <div style={{fontSize:10,color:"#ffaa00",fontWeight:700,marginBottom:6}}>🥅 DRAW — who wins on penalties? <span style={{color:T.dim,fontWeight:400}}>(+1 if correct)</span></div>
                  <div style={{display:"flex",gap:8}}>
                    <button onClick={()=>!locked&&setPred(m.id,"penWinner",pred.penWinner==="home"?"":"home")} disabled={locked} style={{flex:1,background:pred.penWinner==="home"?"rgba(255,170,0,.2)":"rgba(255,255,255,.05)",border:`1px solid ${pred.penWinner==="home"?"#ffaa00":"rgba(255,255,255,.1)"}`,borderRadius:8,padding:"8px",cursor:locked?"default":"pointer",color:pred.penWinner==="home"?"#ffaa00":T.dim,fontSize:12,fontWeight:700,fontFamily:"'DM Sans',sans-serif"}}>{m.home}</button>
                    <button onClick={()=>!locked&&setPred(m.id,"penWinner",pred.penWinner==="away"?"":"away")} disabled={locked} style={{flex:1,background:pred.penWinner==="away"?"rgba(255,170,0,.2)":"rgba(255,255,255,.05)",border:`1px solid ${pred.penWinner==="away"?"#ffaa00":"rgba(255,255,255,.1)"}`,borderRadius:8,padding:"8px",cursor:locked?"default":"pointer",color:pred.penWinner==="away"?"#ffaa00":T.dim,fontSize:12,fontWeight:700,fontFamily:"'DM Sans',sans-serif"}}>{m.away}</button>
                  </div>
                </div>}
        ...
        {page==="admin"&&isAdmin&&<div className="fi">
          ...
          <Section title="ASSIGN PLAYER TO LEAGUE">
            ...
            <div style={{marginTop:14,paddingTop:14,borderTop:"1px solid rgba(255,255,255,.06)"}}>
              ...
              <button onClick={refreshKnockout} style={{background:"rgba(232,192,0,.12)",border:"1px solid rgba(232,192,0,.3)",color:"#e8c000",borderRadius:8,padding:"8px 16px",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13,marginLeft:8}}>🔄 Refresh Knockout Teams</button>
            </div>
          </Section>
          ...
          <Section title="ENTER MATCH RESULTS">
            ...
            {visibleMatches.map(m=>{
              ...
              return <div key={m.id} style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:12,padding:"13px 14px",marginBottom:8}}>
                ...
                {!m.phase.startsWith("Group")&&<div style={{display:"flex",gap:8,alignItems:"center",marginBottom:8,background:"rgba(100,140,255,.05)",borderRadius:8,padding:"8px 10px"}}>
                  <label style={{fontSize:10,color:"#7aa0ff",fontWeight:700,whiteSpace:"nowrap"}}>✏️ SET TEAMS:</label>
                  <input value={m.home} onChange={e=>setMatchTeam(m.id,"home",e.target.value)} placeholder="Home team" style={{flex:1,background:"rgba(255,255,255,.06)",border:"1px solid rgba(100,140,255,.2)",borderRadius:7,padding:"5px 8px",color:"#c0d0e8",fontSize:12,fontFamily:"'DM Sans',sans-serif"}}/>
                  <span style={{color:"#3a4a6a",fontSize:11}}>vs</span>
                  <input value={m.away} onChange={e=>setMatchTeam(m.id,"away",e.target.value)} placeholder="Away team" style={{flex:1,background:"rgba(255,255,255,.06)",border:"1px solid rgba(100,140,255,.2)",borderRadius:7,padding:"5px 8px",color:"#c0d0e8",fontSize:12,fontFamily:"'DM Sans',sans-serif"}}/>
                </div>}
                {(hS>0||aS>0)&&<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
                  <div>
                ...
                {m.id>=73 && res.home!=null && res.home!=="" && res.away!=null && res.away!=="" && parseInt(res.home)===parseInt(res.away) && <div style={{marginTop:8,paddingTop:8,borderTop:"1px solid rgba(255,170,0,.15)"}}>
                  <div style={{fontSize:10,color:"#ffaa00",fontWeight:700,marginBottom:6}}>🥅 DRAW — penalty shootout winner:</div>
                  <div style={{display:"flex",gap:8}}>
                    <button onClick={()=>setMatchResult(m.id,"penWinner",res.penWinner==="home"?"":"home")} style={{flex:1,background:res.penWinner==="home"?"rgba(255,170,0,.25)":"rgba(255,255,255,.05)",border:`1px solid ${res.penWinner==="home"?"#ffaa00":"rgba(255,255,255,.1)"}`,borderRadius:8,padding:"8px",cursor:"pointer",color:res.penWinner==="home"?"#ffaa00":T.dim,fontSize:12,fontWeight:700,fontFamily:"'DM Sans',sans-serif"}}>{m.home}</button>
                    <button onClick={()=>setMatchResult(m.id,"penWinner",res.penWinner==="away"?"":"away")} style={{flex:1,background:res.penWinner==="away"?"rgba(255,170,0,.25)":"rgba(255,255,255,.05)",border:`1px solid ${res.penWinner==="away"?"#ffaa00":"rgba(255,255,255,.1)"}`,borderRadius:8,padding:"8px",cursor:"pointer",color:res.penWinner==="away"?"#ffaa00":T.dim,fontSize:12,fontWeight:700,fontFamily:"'DM Sans',sans-serif"}}>{m.away}</button>
                  </div>
                </div>}
              </div>;
            })}
