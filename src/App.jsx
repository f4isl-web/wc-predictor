...
function isBlackoutWindow() {
  const h = parseInt(new Intl.DateTimeFormat("en-SA",{hour:"numeric",hour12:false,timeZone:"Asia/Riyadh"}).format(new Date()));
  return h >= 11 && h < 13;
}
function calcPoints(pred, result) {
  ...
  const rs=(result.homeScorers||[]).concat(result.awayScorers||[]).map(s=>s.toLowerCase().trim()).filter(Boolean);
  const ps=(pred?.homeScorers||[]).concat(pred?.awayScorers||[]).map(s=>s.toLowerCase().trim()).filter(Boolean);
  ps.forEach(p=>{ if(p&&rs.some(r=>r===p||r.includes(p)||p.includes(r))) pts+=1; });
  return pts;
}
...
const DEFAULT_MATCHES = [
  {id:1,phase:"Group A",home:"Mexico 🇲🇽",away:"South Africa 🇿🇦",date:"Jun 11",kickoffTime:"2026-06-11T22:00"},
  {id:2,phase:"Group A",home:"South Korea 🇰🇷",away:"Czechia 🇨🇿",date:"Jun 11",kickoffTime:"2026-06-12T05:00"},
  {id:3,phase:"Group A",home:"Mexico 🇲🇽",away:"South Korea 🇰🇷",date:"Jun 15",kickoffTime:"2026-06-19T04:00"},
  {id:4,phase:"Group A",home:"South Africa 🇿🇦",away:"Czechia 🇨🇿",date:"Jun 15",kickoffTime:"2026-06-18T19:00"},
  {id:5,phase:"Group A",home:"Mexico 🇲🇽",away:"Czechia 🇨🇿",date:"Jun 19",kickoffTime:"2026-06-25T04:00"},
  {id:6,phase:"Group A",home:"South Africa 🇿🇦",away:"South Korea 🇰🇷",date:"Jun 19",kickoffTime:"2026-06-25T04:00"},
  {id:7,phase:"Group B",home:"Canada 🇨🇦",away:"Bosnia & Herz. 🇧🇦",date:"Jun 12",kickoffTime:"2026-06-12T22:00"},
  {id:8,phase:"Group B",home:"Qatar 🇶🇦",away:"Switzerland 🇨🇭",date:"Jun 13",kickoffTime:"2026-06-13T22:00"},
  {id:9,phase:"Group B",home:"Canada 🇨🇦",away:"Qatar 🇶🇦",date:"Jun 16",kickoffTime:"2026-06-19T01:00"},
  {id:10,phase:"Group B",home:"Switzerland 🇨🇭",away:"Bosnia & Herz. 🇧🇦",date:"Jun 17",kickoffTime:"2026-06-18T22:00"},
  {id:11,phase:"Group B",home:"Canada 🇨🇦",away:"Switzerland 🇨🇭",date:"Jun 21",kickoffTime:"2026-06-24T22:00"},
  {id:12,phase:"Group B",home:"Bosnia & Herz. 🇧🇦",away:"Qatar 🇶🇦",date:"Jun 21",kickoffTime:"2026-06-24T22:00"},
  {id:13,phase:"Group C",home:"Brazil 🇧🇷",away:"Morocco 🇲🇦",date:"Jun 13",kickoffTime:"2026-06-14T01:00"},
  {id:14,phase:"Group C",home:"Haiti 🇭🇹",away:"Scotland 🏴󠁧󠁢󠁳󠁣󠁴󠁿",date:"Jun 13",kickoffTime:"2026-06-14T04:00"},
  {id:15,phase:"Group C",home:"Brazil 🇧🇷",away:"Haiti 🇭🇹",date:"Jun 17",kickoffTime:"2026-06-20T03:30"},
  {id:16,phase:"Group C",home:"Morocco 🇲🇦",away:"Scotland 🏴󠁧󠁢󠁳󠁣󠁴󠁿",date:"Jun 17",kickoffTime:"2026-06-20T01:00"},
  {id:17,phase:"Group C",home:"Brazil 🇧🇷",away:"Scotland 🏴󠁧󠁢󠁳󠁣󠁴󠁿",date:"Jun 21",kickoffTime:"2026-06-25T01:00"},
  {id:18,phase:"Group C",home:"Morocco 🇲🇦",away:"Haiti 🇭🇹",date:"Jun 21",kickoffTime:"2026-06-25T01:00"},
  {id:19,phase:"Group D",home:"USA 🇺🇸",away:"Paraguay 🇵🇾",date:"Jun 12",kickoffTime:"2026-06-13T04:00"},
  {id:20,phase:"Group D",home:"Turkey 🇹🇷",away:"Australia 🇦🇺",date:"Jun 13",kickoffTime:"2026-06-14T07:00"},
  {id:21,phase:"Group D",home:"USA 🇺🇸",away:"Turkey 🇹🇷",date:"Jun 17",kickoffTime:"2026-06-26T05:00"},
  {id:22,phase:"Group D",home:"Australia 🇦🇺",away:"Paraguay 🇵🇾",date:"Jun 17",kickoffTime:"2026-06-26T05:00"},
  {id:23,phase:"Group D",home:"USA 🇺🇸",away:"Australia 🇦🇺",date:"Jun 21",kickoffTime:"2026-06-19T22:00"},
  {id:24,phase:"Group D",home:"Paraguay 🇵🇾",away:"Turkey 🇹🇷",date:"Jun 21",kickoffTime:"2026-06-20T06:00"},
  {id:25,phase:"Group E",home:"Germany 🇩🇪",away:"Curaçao 🇨🇼",date:"Jun 14",kickoffTime:"2026-06-14T20:00"},
  {id:26,phase:"Group E",home:"Ecuador 🇪🇨",away:"Ivory Coast 🇨🇮",date:"Jun 14",kickoffTime:"2026-06-15T02:00"},
  {id:27,phase:"Group E",home:"Germany 🇩🇪",away:"Ecuador 🇪🇨",date:"Jun 18",kickoffTime:"2026-06-25T23:00"},
  {id:28,phase:"Group E",home:"Curaçao 🇨🇼",away:"Ivory Coast 🇨🇮",date:"Jun 18",kickoffTime:"2026-06-25T23:00"},
  {id:29,phase:"Group E",home:"Germany 🇩🇪",away:"Ivory Coast 🇨🇮",date:"Jun 22",kickoffTime:"2026-06-20T23:00"},
  {id:30,phase:"Group E",home:"Curaçao 🇨🇼",away:"Ecuador 🇪🇨",date:"Jun 22",kickoffTime:"2026-06-21T03:00"},
  {id:31,phase:"Group F",home:"Japan 🇯🇵",away:"Netherlands 🇳🇱",date:"Jun 14",kickoffTime:"2026-06-14T23:00"},
  {id:32,phase:"Group F",home:"Sweden 🇸🇪",away:"Tunisia 🇹🇳",date:"Jun 15",kickoffTime:"2026-06-15T05:00"},
  {id:33,phase:"Group F",home:"Japan 🇯🇵",away:"Sweden 🇸🇪",date:"Jun 19",kickoffTime:"2026-06-26T02:00"},
  {id:34,phase:"Group F",home:"Netherlands 🇳🇱",away:"Tunisia 🇹🇳",date:"Jun 19",kickoffTime:"2026-06-26T02:00"},
  {id:35,phase:"Group F",home:"Japan 🇯🇵",away:"Tunisia 🇹🇳",date:"Jun 23",kickoffTime:"2026-06-21T07:00"},
  {id:36,phase:"Group F",home:"Netherlands 🇳🇱",away:"Sweden 🇸🇪",date:"Jun 23",kickoffTime:"2026-06-20T20:00"},
  {id:37,phase:"Group G",home:"Belgium 🇧🇪",away:"Egypt 🇪🇬",date:"Jun 15",kickoffTime:"2026-06-15T22:00"},
  {id:38,phase:"Group G",home:"Iran 🇮🇷",away:"New Zealand 🇳🇿",date:"Jun 15",kickoffTime:"2026-06-16T04:00"},
  {id:39,phase:"Group G",home:"Belgium 🇧🇪",away:"Iran 🇮🇷",date:"Jun 19",kickoffTime:"2026-06-21T22:00"},
  {id:40,phase:"Group G",home:"Egypt 🇪🇬",away:"New Zealand 🇳🇿",date:"Jun 19",kickoffTime:"2026-06-22T04:00"},
  {id:41,phase:"Group G",home:"Belgium 🇧🇪",away:"New Zealand 🇳🇿",date:"Jun 23",kickoffTime:"2026-06-27T06:00"},
  {id:42,phase:"Group G",home:"Egypt 🇪🇬",away:"Iran 🇮🇷",date:"Jun 23",kickoffTime:"2026-06-27T06:00"},
  {id:43,phase:"Group H",home:"Spain 🇪🇸",away:"Uruguay 🇺🇾",date:"Jun 15",kickoffTime:"2026-06-15T19:00"},
  {id:44,phase:"Group H",home:"Cape Verde 🇨🇻",away:"Saudi Arabia 🇸🇦",date:"Jun 16",kickoffTime:"2026-06-27T03:00"},
  {id:45,phase:"Group H",home:"Spain 🇪🇸",away:"Cape Verde 🇨🇻",date:"Jun 20",kickoffTime:"2026-06-27T03:00"},
  {id:46,phase:"Group H",home:"Saudi Arabia 🇸🇦",away:"Uruguay 🇺🇾",date:"Jun 20",kickoffTime:"2026-06-16T01:00"},
  {id:47,phase:"Group H",home:"Spain 🇪🇸",away:"Saudi Arabia 🇸🇦",date:"Jun 24",kickoffTime:"2026-06-21T19:00"},
  {id:48,phase:"Group H",home:"Uruguay 🇺🇾",away:"Cape Verde 🇨🇻",date:"Jun 24",kickoffTime:"2026-06-22T01:00"},
  {id:49,phase:"Group I",home:"France 🇫🇷",away:"Iraq 🇮🇶",date:"Jun 16",kickoffTime:"2026-06-16T22:00"},
  {id:50,phase:"Group I",home:"Senegal 🇸🇳",away:"Norway 🇳🇴",date:"Jun 16",kickoffTime:"2026-06-17T01:00"},
  {id:51,phase:"Group I",home:"France 🇫🇷",away:"Senegal 🇸🇳",date:"Jun 20",kickoffTime:"2026-06-23T00:00"},
  {id:52,phase:"Group I",home:"Norway 🇳🇴",away:"Iraq 🇮🇶",date:"Jun 20",kickoffTime:"2026-06-23T03:00"},
  {id:53,phase:"Group I",home:"France 🇫🇷",away:"Norway 🇳🇴",date:"Jun 24",kickoffTime:"2026-06-26T22:00"},
  {id:54,phase:"Group I",home:"Senegal 🇸🇳",away:"Iraq 🇮🇶",date:"Jun 24",kickoffTime:"2026-06-26T22:00"},
  {id:55,phase:"Group J",home:"Argentina 🇦🇷",away:"Jordan 🇯🇴",date:"Jun 16",kickoffTime:"2026-06-28T05:00"},
  {id:56,phase:"Group J",home:"Algeria 🇩🇿",away:"Austria 🇦🇹",date:"Jun 17",kickoffTime:"2026-06-28T05:00"},
  {id:57,phase:"Group J",home:"Argentina 🇦🇷",away:"Algeria 🇩🇿",date:"Jun 21",kickoffTime:"2026-06-17T04:00"},
  {id:58,phase:"Group J",home:"Austria 🇦🇹",away:"Jordan 🇯🇴",date:"Jun 21",kickoffTime:"2026-06-17T07:00"},
  {id:59,phase:"Group J",home:"Argentina 🇦🇷",away:"Austria 🇦🇹",date:"Jun 25",kickoffTime:"2026-06-22T20:00"},
  {id:60,phase:"Group J",home:"Jordan 🇯🇴",away:"Algeria 🇩🇿",date:"Jun 25",kickoffTime:"2026-06-23T06:00"},
  {id:61,phase:"Group K",home:"Portugal 🇵🇹",away:"Colombia 🇨🇴",date:"Jun 17",kickoffTime:"2026-06-17T20:00"},
  {id:62,phase:"Group K",home:"DR Congo 🇨🇩",away:"Uzbekistan 🇺🇿",date:"Jun 17",kickoffTime:"2026-06-28T02:30"},
  {id:63,phase:"Group K",home:"Portugal 🇵🇹",away:"DR Congo 🇨🇩",date:"Jun 22",kickoffTime:"2026-06-28T02:30"},
  {id:64,phase:"Group K",home:"Colombia 🇨🇴",away:"Uzbekistan 🇺🇿",date:"Jun 22",kickoffTime:"2026-06-18T05:00"},
  {id:65,phase:"Group K",home:"Portugal 🇵🇹",away:"Uzbekistan 🇺🇿",date:"Jun 26",kickoffTime:"2026-06-23T20:00"},
  {id:66,phase:"Group K",home:"Colombia 🇨🇴",away:"DR Congo 🇨🇩",date:"Jun 26",kickoffTime:"2026-06-24T05:00"},
  {id:67,phase:"Group L",home:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",away:"Panama 🇵🇦",date:"Jun 17",kickoffTime:"2026-06-28T00:00"},
  {id:68,phase:"Group L",home:"Croatia 🇭🇷",away:"Ghana 🇬🇭",date:"Jun 18",kickoffTime:"2026-06-28T00:00"},
  {id:69,phase:"Group L",home:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",away:"Croatia 🇭🇷",date:"Jun 22",kickoffTime:"2026-06-17T23:00"},
  {id:70,phase:"Group L",home:"Ghana 🇬🇭",away:"Panama 🇵🇦",date:"Jun 22",kickoffTime:"2026-06-18T02:00"},
  {id:71,phase:"Group L",home:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",away:"Ghana 🇬🇭",date:"Jun 26",kickoffTime:"2026-06-23T23:00"},
  {id:72,phase:"Group L",home:"Panama 🇵🇦",away:"Croatia 🇭🇷",date:"Jun 26",kickoffTime:"2026-06-24T02:00"},
  {id:73,phase:"Round of 32",home:"1A",away:"2B",date:"Jun 29",kickoffTime:"2026-06-29T03:00"},
  {id:74,phase:"Round of 32",home:"1B",away:"2A",date:"Jun 29",kickoffTime:"2026-06-29T03:00"},
  {id:75,phase:"Round of 32",home:"1C",away:"2D",date:"Jun 30",kickoffTime:"2026-06-30T01:00"},
  {id:76,phase:"Round of 32",home:"1D",away:"2C",date:"Jun 30",kickoffTime:"2026-06-30T01:00"},
  {id:77,phase:"Round of 32",home:"1E",away:"2F",date:"Jul 1",kickoffTime:"2026-07-01T01:00"},
  {id:78,phase:"Round of 32",home:"1F",away:"2E",date:"Jul 1",kickoffTime:"2026-07-01T01:00"},
  {id:79,phase:"Round of 32",home:"1G",away:"2H",date:"Jul 2",kickoffTime:"2026-07-02T01:00"},
  {id:80,phase:"Round of 32",home:"1H",away:"2G",date:"Jul 2",kickoffTime:"2026-07-02T01:00"},
  {id:81,phase:"Round of 32",home:"1I",away:"2J",date:"Jul 3",kickoffTime:"2026-07-03T01:00"},
  {id:82,phase:"Round of 32",home:"1J",away:"2I",date:"Jul 3",kickoffTime:"2026-07-03T01:00"},
  {id:83,phase:"Round of 32",home:"1K",away:"2L",date:"Jul 4",kickoffTime:"2026-07-04T01:00"},
  {id:84,phase:"Round of 32",home:"1L",away:"2K",date:"Jul 4",kickoffTime:"2026-07-04T01:00"},
  {id:85,phase:"Round of 32",home:"3rd best 1",away:"3rd best 2",date:"Jul 5",kickoffTime:"2026-07-05T01:00"},
  {id:86,phase:"Round of 32",home:"3rd best 3",away:"3rd best 4",date:"Jul 5",kickoffTime:"2026-07-05T01:00"},
  {id:87,phase:"Round of 32",home:"W73",away:"W74",date:"Jul 5",kickoffTime:"2026-07-05T01:00"},
  {id:88,phase:"Round of 32",home:"W75",away:"W76",date:"Jul 6",kickoffTime:"2026-07-06T01:00"},
  {id:89,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 7",kickoffTime:"2026-07-07T23:00"},
  {id:90,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 7",kickoffTime:"2026-07-08T03:00"},
  {id:91,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 8",kickoffTime:"2026-07-08T23:00"},
  {id:92,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 8",kickoffTime:"2026-07-09T03:00"},
  {id:93,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 9",kickoffTime:"2026-07-09T23:00"},
  {id:94,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 9",kickoffTime:"2026-07-10T03:00"},
  {id:95,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 10",kickoffTime:"2026-07-10T23:00"},
  {id:96,phase:"Round of 16",home:"TBD",away:"TBD",date:"Jul 10",kickoffTime:"2026-07-11T03:00"},
  {id:97,phase:"Quarter-Final",home:"TBD",away:"TBD",date:"Jul 14",kickoffTime:"2026-07-16T23:00"},
  {id:98,phase:"Quarter-Final",home:"TBD",away:"TBD",date:"Jul 14",kickoffTime:"2026-07-17T22:00"},
  {id:99,phase:"Quarter-Final",home:"TBD",away:"TBD",date:"Jul 15",kickoffTime:"2026-07-18T00:00"},
  {id:100,phase:"Quarter-Final",home:"TBD",away:"TBD",date:"Jul 15",kickoffTime:"2026-07-18T04:00"},
  {id:101,phase:"Semi-Final",home:"TBD",away:"TBD",date:"Jul 18",kickoffTime:"2026-07-21T22:00"},
  {id:102,phase:"Semi-Final",home:"TBD",away:"TBD",date:"Jul 19",kickoffTime:"2026-07-22T22:00"},
  {id:103,phase:"Third Place",home:"TBD",away:"TBD",date:"Jul 22",kickoffTime:"2026-07-25T23:00"},
  {id:104,phase:"Final",home:"TBD",away:"TBD",date:"Jul 26",kickoffTime:"2026-07-26T22:00"},
];
...
const DEFAULT_SQUADS = {
  ...
  "Canada 🇨🇦":{GK:["Dayne St. Clair","Maxime Crepeau","Owen Goodman"],DEF:["Alistair Johnston","Luc de Fougerolles","Alfie Jones","Joel Waterman","Derek Cornelius","Moise Bombito","Alphonso Davies","Richie Laryea","Niko Sigur"],MID:["Mathieu Choiniere","Stephen Eustaquio","Ismael Kone","Liam Millar","Jacob Shaffelburg","Jonathan Osorio","Ali Ahmed","Nathan Saliba","Tajon Buchanan"],ATT:["Cyle Larin","Jonathan David","Tani Oluwaseyi","Promise David"]},
  ...
  "Paraguay 🇵🇾":{GK:["Gatito Fernandez","Orlando Gill","Gaston Olveira"],DEF:["Gustavo Gomez","Junior Alonso","Fabian Balbuena","Omar Alderete","Juan Jose Caceres","Gustavo Velazquez","Jose Canale","Alexandro Maidana"],MID:["Miguel Almiron","Kaku","Andres Cubas","Ramon Sosa","Diego Gomez","Damian Bobadilla","Braian Ojeda","Matias Galarza"],ATT:["Antonio Sanabria","Julio Enciso","Gabriel Avalos","Alex Arce","Isidro Pitta","Gustavo Caballero"]},
  ...
  "Sweden 🇸🇪":{GK:["Viktor Johansson","Gustaf Lagerbielke","Kristoffer Nordfeldt","Jacob Zetterstrom"],DEF:["Hjalmar Ekdal","Gabriel Gudmundsson","Isak Hien","Victor Lindelof","Eric Smith","Carl Starfelt","Daniel Svensson"],MID:["Yasin Ayari","Lucas Bergvall","Jesper Karlstrom","Benjamin Nygren","Ken Sema","Elliot Stroud","Mattias Svanberg","Besfort Zeneli"],ATT:["Taha Ali","Alexander Bernhardsson","Anthony Elanga","Viktor Gyokeres","Alexander Isak","Gustaf Nilsson"]},
...
const API_PROXY = "https://corsproxy.io/?https://v3.football.api-sports.io";
async function fetchLiveScores(matches, onUpdated) {
  try {
    const res = await fetch(`${API_PROXY}/fixtures?league=1&season=2026&timezone=Asia/Riyadh`,{headers:{"x-apisports-key":API_KEY}});
    if(!res.ok) return;
    const fixtures=(await res.json()).response||[];
    const live=fixtures.filter(f=>["FT","AET","PEN","1H","2H","HT","ET","P","LIVE"].includes(f.fixture?.status?.short));
    if(!live.length) return;
    const strip=s=>s.replace(/\p{Emoji}/gu,"").trim().toLowerCase();
    let anyUpdated=false;
    const updated=matches.map(m=>{
      const mH=strip(m.home),mA=strip(m.away);
      const fix=live.find(f=>{const fH=(f.teams?.home?.name||"").toLowerCase(),fA=(f.teams?.away?.name||"").toLowerCase();return(fH.includes(mH)||mH.includes(fH))&&(fA.includes(mA)||mA.includes(fA));});
      if(!fix||fix.goals?.home==null) return m;
      const ev=fix.events||[];
      const newR={home:String(fix.goals.home),away:String(fix.goals.away),homeScorers:ev.filter(e=>e.team?.id===fix.teams?.home?.id&&e.type==="Goal"&&e.detail!=="Own Goal").map(e=>e.player?.name||""),awayScorers:ev.filter(e=>e.team?.id===fix.teams?.away?.id&&e.type==="Goal"&&e.detail!=="Own Goal").map(e=>e.player?.name||""),autoSynced:true};
      if(JSON.stringify(m.result)===JSON.stringify(newR)) return m;
      anyUpdated=true;
      return{...m,result:newR};
    });
    if(anyUpdated) onUpdated(updated);
  } catch{}
}
...
export default function App() {
  ...
  const [activeLeague, setActiveLeague] = useState(null);   // leagueId currently viewing
  ...
  useEffect(()=>{
    const uns = [
      ...
      fbListen("matches",     v=>{ if(v){ const arr=Object.values(v); arr.sort((a,b)=>a.id-b.id); setMatches(arr); } else { fbSet("matches",Object.fromEntries(DEFAULT_MATCHES.map(m=>[m.id,m]))); } }),
  ...
  useEffect(()=>{
    ...
    const sync=async()=>{
      ...
      await fetchLiveScores(matches, updated=>{
        setMatches(updated);
        fbSet("matches",Object.fromEntries(updated.map(m=>[m.id,m])));
      });
  ...
  const leaderboard = leagueMembers.map(u=>{
    ...
    matches.forEach(m=>{
      const pred = predictions[activeLeague]?.[u]?.[m.id];
  ...
  const setPred=(matchId,field,val)=>{
    ...
    fbSet(`predictions/${activeLeague}/${session}/${matchId}/${field}`,val);
    setPredictions(prev=>({...prev,[activeLeague]:{...prev[activeLeague],[session]:{...prev[activeLeague]?.[session],[matchId]:{...prev[activeLeague]?.[session]?.[matchId],[field]:val}}}}));
  };

  // ── Match admin ────────────────────────────────────────────────────────────
  const setMatchResult=(id,field,val)=>{
    fbSet(`matches/${id}/result/${field}`,val);
    setMatches(prev=>prev.map(m=>m.id===id?{...m,result:{...m.result,[field]:val}}:m));
  };
  const setMatchKickoff=(id,val)=>{
    fbSet(`matches/${id}/kickoffTime`,val);
    setMatches(prev=>prev.map(m=>m.id===id?{...m,kickoffTime:val}:m));
  };
    ...
    <div style={{minHeight:"100vh",background:T.bg,color:"#f0f0f0",fontFamily:"'DM Sans',sans-serif"}}>
        ...
        <div style={{position:"relative",padding:"20px 20px 14px",display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          ...
          {session?(
            <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6}}>
              ...
              <button onClick={()=>{setSession(null);setPage("scoreboard");setActiveLeague(null);}} style={{background:"rgba(255,80,80,.1)",border:"1px solid rgba(255,80,80,.2)",color:"#ff6666",borderRadius:8,padding:"4px 12px",cursor:"pointer",fontSize:12,fontWeight:600}}>Sign out</button>
            </div>
          ):(
      ...
      <div style={{padding:"22px 16px",maxWidth:760,margin:"0 auto"}}>
          ...
          {!activeLeague ? <NoLeague/> : <>
            ...
            {selectedPlayer&&(()=>{
              ...
              return <div>
                ...
                {visibleMatches.map(m=>{
                  const pred=predictions[activeLeague]?.[selectedPlayer]?.[m.id];
        ...
        {page==="predict"&&session&&<div className="fi">
          ...
          <LeagueSwitcher/>
          {!activeLeague ? <NoLeague/> : <>
            <div style={{fontSize:12,color:T.dim,marginBottom:16}}>Locks 2h before kickoff · +1 outcome · +3 exact · +1 per scorer</div>
            <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:18}}>{phases.map(ph=><Pill key={ph} active={phaseFilter===ph} onClick={()=>setPhaseFilter(ph)}>{ph}</Pill>)}</div>
            {visibleMatches.map(m=>{
              const pred=predictions[activeLeague]?.[session]?.[m.id]||{};
              const pts=calcPoints(pred,m.result);
              const hasRes=m.result?.home!=null&&m.result?.home!=="";
              ...
              return <div key={m.id} style={{background:T.card,border:`1px solid ${locked&&!hasRes?"rgba(255,100,0,.2)":T.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                  <div>
                    ...
                    <div style={{fontSize:11,color:T.dim}}>{m.date}{m.kickoffTime&&!hasRes&&<span style={{marginLeft:8,color:locked?"#ff6666":deadline?"#44cc88":"#7a8aaa"}}>{locked?"🔒 locked":deadline?`⏳ ${deadline}`:"✅ open"}</span>}</div>
                  </div>
        ...
        {page==="admin"&&isAdmin&&<div className="fi">
          <div style={{fontFamily:"'Bebas Neue',Impact,sans-serif",fontSize:26,letterSpacing:3,color:T.gold,marginBottom:20,display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
            ADMIN PANEL
            <button onClick={async()=>{setApiSyncing(true);await fetchLiveScores(matches,upd=>{setMatches(upd);fbSet("matches",Object.fromEntries(upd.map(m=>[m.id,m])));});setLastApiSync(new Date());setApiSyncing(false);showToast("Scores synced!");}} style={{background:"rgba(68,204,136,.15)",border:"1px solid rgba(68,204,136,.3)",color:"#44cc88",borderRadius:8,padding:"6px 14px",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:12}}>{apiSyncing?"⏳ Syncing…":"⚽ Sync Scores"}</button>
          </div>
            ...
            {visibleMatches.map(m=>{
              ...
              return <div key={m.id} style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:12,padding:"13px 14px",marginBottom:8}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:8}}>
                  <div style={{fontSize:10,color:T.gold,fontWeight:700,minWidth:80}}>{m.phase}<br/><span style={{color:T.dim}}>{m.date}</span>{m.result?.autoSynced&&<span style={{display:"block",color:"#44cc88",fontSize:9}}>⚽ auto</span>}</div>
                  <div style={{flex:1,fontWeight:600,fontSize:13}}>{m.home}</div>
