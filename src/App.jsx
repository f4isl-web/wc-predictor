...
const DEFAULT_MATCHES = [
  ...
  {id:71,phase:"Group L",home:"Panama 🇵🇦",away:"England 🏴󠁧󠁢󠁥󠁮󠁧󠁿",date:"Jun 27",kickoffTime:"2026-06-27T07:00+03:00"},
  {id:72,phase:"Group L",home:"Croatia 🇭🇷",away:"Ghana 🇬🇭",date:"Jun 27",kickoffTime:"2026-06-27T07:00+03:00"},
...
export default function App() {
  ...
  const setPredFor=(leagueId,uname,matchId,field,val)=>{
    ...
    const userLeagues = users[uname]?.leagues || [leagueId];
    const targetLeagues = (matchId >= MIRROR_FROM_MATCH && userLeagues.length > 1) ? userLeagues : [leagueId];
    setPredictions(prev=>{
      const next = {...prev};
      targetLeagues.forEach(lg=>{
